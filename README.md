...
![img](./01/clip_image034.jpg)

试着更改一下论文2的名字然后删除论文1，再进行查询：

![img](./01/clip_image036.jpg) ![img](./01/clip_image038.jpg)

![img](./01/clip_image040.jpg)
...
![img](./01/clip_image050.jpg)

为10001在添加一个新课：

![img](./01/clip_image052.jpg)

查询其所有授课记录：

![img](./01/clip_image054.jpg)

删除刚才添加的课程，然后将10001在数学分析1的承担学时改为2，然后查询数学分析1：

![img](./01/clip_image056.jpg) ![img](./01/clip_image058.jpg)

![img](./01/clip_image060.jpg)

最最后，我们对10001的1998年~2023年的所有成就查询一下，并设置输出pdf画框宽度为2000，高度仍为默认：

![img](./01/clip_image062.jpg)

输出的可视查询窗口：

![img](./01/clip_image064.jpg)

输出的pdf：

![img](./01/clip_image066.jpg)
